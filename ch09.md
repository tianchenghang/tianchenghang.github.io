...
let obj = {
  foo: 1,
  bar: 2,
  // 使用 ["expr"] 属性名表达式定义 prop
  ["baz"]: 4,
  [propKey]: 3,
  // 使用 ["expr"] 属性名表达式定义 method
  ["meth"]() {
    console.log("wtf");
  },
};
...
| 属性的遍历                        | 自身属性 | 继承属性 | 数值, 字符串属性 | Symbol 属性 | enumerable       |
| --------------------------------- | -------- | -------- | ---------------- | ----------- | ---------------- |
| for...in                          | 包括     | 包括     | 包括             | 不包括      | 可遍历           |
| Object.keys()                     | 包括     | 不包括   | 包括             | 不包括      | 可遍历           |
| Object.getOwnPropertyNames(obj)   | 包括     | 不包括   | 包括             | 不包括      | 可遍历, 不可遍历 |
| Object.getOwnPropertySymbols(obj) | 包括     | 不包括   | 不包括           | 包括        | 可遍历, 不可遍历 |
| Reflect.ownKeys(obj);             | 包括     | 不包括   | 包括             | 包括        | 可遍历, 不可遍历 |
