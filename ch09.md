...
| 属性的遍历                     | 自身属性 | 继承属性 | 字符串属性名 | Symbol 属性名 | enumerable  |
| ------------------------------ | -------- | -------- | ------------ | ------------- | ----------- |
| for...in, for...of             | 包括     | 包括     | 包括         | 不包括        | true        |
| Object.keys()                  | 包括     | 不包括   | 包括         | 不包括        | true        |
| Object.getOwnPropertyNames()   | 包括     | 不包括   | 包括         | 不包括        | true, false |
| Object.getOwnPropertySymbols() | 包括     | 不包括   | 不包括       | 包括          | true, false |
| Reflect.ownKeys();             | 包括     | 不包括   | 包括         | 包括          | true, false |
