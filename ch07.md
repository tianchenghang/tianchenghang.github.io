...
const t1 = Date.now();
console.log(fib1(50));
console.log(Date.now() - t1); // about 141470
...
> ES6 的尾调用, 严格模式下可用, 非严格模式下不可用

非严格模式下, 函数体中有 2 个用于跟踪函数调用栈的变量, 严格模式下没有

- func.arguments func 函数的参数列表
- func.caller 调用 func 函数的函数
