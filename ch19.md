...
- super 作为函数: 只允许在子类的构造方法中调用 super(), 即调用父类的构造方法以初始化 this, super() 等价于 `Parent.prototype.constructor.call(this)`, 即使用子类的 this 调用父类的构造方法
- super 作为对象
  - 在子类的实例方法 (包括构造方法) 中, super 指向 `Parent.prototype`, 可以调用父类的实例方法, 父类方法中的 this 指向子类实例
  - 在子类的静态方法中, super 指向 `Parent`, 可以调用父类的静态方法, 父类方法中的 this 指向子类
...
class Child extends Parent {
  constructor() {
    super(); // this.foo = 1;
    this.foo = 2;
    super.foo = 3; //? Parent.prototype.foo = 3
