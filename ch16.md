...
\_next, catch 方法的 onfulfilled, onrejected 回调函数
...
4. 如果回调函数中 throw reason, 则 \_next, catch 返回 Promise{ PromiseState: rejected, PromiseReturn: reason }
5. 如果回调函数中 return value (没有 return 等价于 return undefined), 则 \_next, catch 返回 Promise{ PromiseState: fulfilled, PromiseReturn: value }
...
- promise.catch(onrejected) 等价于 promise.\_next(undefined, onrejected)
