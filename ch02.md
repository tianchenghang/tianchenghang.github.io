...
3. 浏览器中, this, self 都指向顶层对象 window
4. node 中, this 指向顶层对象 global
...
9. new Function('return this')(); 返回全局对象, 但浏览器使用 CSP, Content Security Policy 内容安全策略时, 不允许调用 eval, new Function 等方法
